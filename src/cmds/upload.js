...
exports.desc = 'Generates the *.codiusstate manifest from codius.json & codiusvars.json then uploads the contract to a random # of host(s) or a specific set of host(s)'
